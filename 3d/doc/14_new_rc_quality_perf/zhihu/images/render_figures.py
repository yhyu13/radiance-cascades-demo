...
def fig8_takeaway():
    img, d = canvas()
    t(d, (40, 28), "辐射度级联就这四刀", F_TITLE)
    t(d, (40, 78), "近密远疏、长在墙上、四块是上限、空白不必算。", F_P, MUTED)

    items = [
        (GREEN, "分层", "近处密，远处细", "每像素打几百条"),
        (ACCENT, "长在哪", "长在墙上，只问内侧", "铺在空里的那套"),
        (AMBER, "上限", "最近一层只有四块", "乘系数把图拧亮"),
        (MUTED, "空活", "图集空白不必算", "报快了几倍"),
    ]
