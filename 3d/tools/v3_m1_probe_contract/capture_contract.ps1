...
$outDir = "tools/v3_m1_probe_contract/captures_$Scene"
$tag = "m1contract_${Scene}_baseline_N$('{0:D4}' -f $N)_m17"
...
& $exe @argList |
    Select-String -Pattern "measurement-camera|use-hybrid|hdr-exr|probe-stats|screenshot saved" |
