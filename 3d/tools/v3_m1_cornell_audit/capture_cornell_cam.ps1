...
$outDir = "tools/v3_m1_cornell_audit/captures_cornell_cam$Cam"
$tag = "m1stage11b_cornell_cam${Cam}_g100_N$('{0:D4}' -f $N)_m17"
...
Write-Host "[m1-stage11b] $tag -> $logFile"
& $exe @argList *> $logFile
Write-Host "[m1-stage11b] $tag exit=$LASTEXITCODE"
